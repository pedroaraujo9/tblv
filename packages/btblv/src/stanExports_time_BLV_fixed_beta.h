...
namespace model_time_BLV_fixed_beta_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 71> locations_array__ =
  {" (found before start of program)",
  " (in 'time_BLV_fixed_beta', line 19, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 20, column 2 to column 21)",
  " (in 'time_BLV_fixed_beta', line 21, column 2 to column 24)",
  " (in 'time_BLV_fixed_beta', line 22, column 2 to column 22)",
  " (in 'time_BLV_fixed_beta', line 23, column 2 to column 36)",
  " (in 'time_BLV_fixed_beta', line 24, column 2 to column 23)",
  " (in 'time_BLV_fixed_beta', line 27, column 2 to column 21)",
  " (in 'time_BLV_fixed_beta', line 28, column 2 to column 36)",
  " (in 'time_BLV_fixed_beta', line 29, column 2 to column 59)",
  " (in 'time_BLV_fixed_beta', line 30, column 2 to column 47)",
  " (in 'time_BLV_fixed_beta', line 31, column 2 to column 44)",
  " (in 'time_BLV_fixed_beta', line 34, column 4 to column 76)",
  " (in 'time_BLV_fixed_beta', line 33, column 17 to line 35, column 3)",
  " (in 'time_BLV_fixed_beta', line 33, column 2 to line 35, column 3)",
  " (in 'time_BLV_fixed_beta', line 38, column 4 to line 39, column 43)",
  " (in 'time_BLV_fixed_beta', line 37, column 21 to line 40, column 3)",
  " (in 'time_BLV_fixed_beta', line 37, column 2 to line 40, column 3)",
  " (in 'time_BLV_fixed_beta', line 43, column 2 to column 28)",
  " (in 'time_BLV_fixed_beta', line 44, column 2 to column 33)",
  " (in 'time_BLV_fixed_beta', line 46, column 4 to column 32)",
  " (in 'time_BLV_fixed_beta', line 47, column 4 to column 28)",
  " (in 'time_BLV_fixed_beta', line 45, column 17 to line 48, column 3)",
  " (in 'time_BLV_fixed_beta', line 45, column 2 to line 48, column 3)",
  " (in 'time_BLV_fixed_beta', line 50, column 4 to column 30)",
  " (in 'time_BLV_fixed_beta', line 49, column 16 to line 51, column 3)",
  " (in 'time_BLV_fixed_beta', line 49, column 2 to line 51, column 3)",
  " (in 'time_BLV_fixed_beta', line 53, column 4 to column 24)",
  " (in 'time_BLV_fixed_beta', line 52, column 16 to line 54, column 3)",
  " (in 'time_BLV_fixed_beta', line 52, column 2 to line 54, column 3)",
  " (in 'time_BLV_fixed_beta', line 55, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 55, column 12 to column 13)",
  " (in 'time_BLV_fixed_beta', line 55, column 2 to column 62)",
  " (in 'time_BLV_fixed_beta', line 57, column 4 to column 48)",
  " (in 'time_BLV_fixed_beta', line 56, column 16 to line 58, column 3)",
  " (in 'time_BLV_fixed_beta', line 56, column 2 to line 58, column 3)",
  " (in 'time_BLV_fixed_beta', line 2, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 3, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 4, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 5, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 6, column 27 to column 28)",
  " (in 'time_BLV_fixed_beta', line 6, column 30 to column 31)",
  " (in 'time_BLV_fixed_beta', line 6, column 2 to column 35)",
  " (in 'time_BLV_fixed_beta', line 7, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 7, column 2 to column 17)",
  " (in 'time_BLV_fixed_beta', line 8, column 2 to column 9)",
  " (in 'time_BLV_fixed_beta', line 9, column 17 to column 19)",
  " (in 'time_BLV_fixed_beta', line 9, column 2 to column 21)",
  " (in 'time_BLV_fixed_beta', line 10, column 17 to column 21)",
  " (in 'time_BLV_fixed_beta', line 10, column 2 to column 23)",
  " (in 'time_BLV_fixed_beta', line 11, column 20 to column 24)",
  " (in 'time_BLV_fixed_beta', line 11, column 2 to column 26)",
  " (in 'time_BLV_fixed_beta', line 12, column 15 to column 19)",
  " (in 'time_BLV_fixed_beta', line 12, column 2 to column 21)",
  " (in 'time_BLV_fixed_beta', line 15, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 15, column 12 to column 13)",
  " (in 'time_BLV_fixed_beta', line 15, column 2 to column 27)",
  " (in 'time_BLV_fixed_beta', line 16, column 2 to column 37)",
  " (in 'time_BLV_fixed_beta', line 19, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 19, column 12 to column 13)",
  " (in 'time_BLV_fixed_beta', line 20, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 20, column 12 to column 13)",
  " (in 'time_BLV_fixed_beta', line 21, column 9 to column 12)",
  " (in 'time_BLV_fixed_beta', line 23, column 28 to column 30)",
  " (in 'time_BLV_fixed_beta', line 24, column 9 to column 11)",
  " (in 'time_BLV_fixed_beta', line 27, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 27, column 12 to column 13)",
  " (in 'time_BLV_fixed_beta', line 28, column 9 to column 11)",
  " (in 'time_BLV_fixed_beta', line 29, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 30, column 9 to column 10)",
  " (in 'time_BLV_fixed_beta', line 31, column 18 to column 19)"};
#include <stan_meta_header.hpp>
class model_time_BLV_fixed_beta final : public model_base_crtp<model_time_BLV_fixed_beta> {
private:
  int n;
  int J;
  int N;
...
public:
  ~model_time_BLV_fixed_beta() {}
  model_time_BLV_fixed_beta(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_time_BLV_fixed_beta_namespace::model_time_BLV_fixed_beta";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = (n * K) + (J * K) + delta_raw_1dim__ + 1 + Ng + Ng;
  }
  inline std::string model_name() const final {
    return "model_time_BLV_fixed_beta";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_time_BLV_fixed_beta_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_time_BLV_fixed_beta_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"E", "alpha", "delta_raw",
                "baseline_delta", "phi", "log_sigma"};
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"theta", "sigma", "delta", "log_kappa", "kappa"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"E\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(J) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"delta_raw\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(delta_raw_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"baseline_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Ng) + "},\"block\":\"parameters\"},{\"name\":\"log_sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Ng) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Ng) + "},\"block\":\"transformed_parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((((n * K) + (J * K)) + delta_raw_1dim__) +
      1) + Ng) + Ng);
...
using stan_model = model_time_BLV_fixed_beta_namespace::model_time_BLV_fixed_beta;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_time_BLV_fixed_beta_namespace::profiles__;
}
#endif
#endif
