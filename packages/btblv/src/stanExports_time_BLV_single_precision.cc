...
#include "stanExports_time_BLV_single_precision.h"

RCPP_MODULE(stan_fit4time_BLV_single_precision_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_time_BLV_single_precision")
