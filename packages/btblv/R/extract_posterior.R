...
#' @param add_btblv_fit logical value indicating if the object should contain the btblv_fit,
#' default is TRUE.
#' @param alpha_reference alpha reference matrix for the procrustean matching procedure.
#' It is "PCA" for the PCA eigen values applied to the logit(y),
...
extract_posterior = function(btblv_fit,
  ...
  }else if(alpha_reference == "posterior mode") {
