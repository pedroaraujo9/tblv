#' Generate data from the model based on the posterior mean of the parameters
#'
...
#' @examples
#' #
generate_data = function(btblv_posterior, replicates, seed) {
  ...
  out = list(
    ...
    true_parameters = btblv_posterior$post_sample_array,
    seed = seed
  )
